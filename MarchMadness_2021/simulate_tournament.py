...
###################################
headliner = "Baylor beats Gonzaga"
i = 67
...
def sim_tournament():
    ...
    # First Four
    west_firstfour_16 = sim_game(norfolk_state, appalachian_state, -1, points_dict, [1,0])
    west_firstfour_11 = sim_game(wichita_state, drake, -1, points_dict, [2,0])
    east_firstfour_16 = sim_game(mount_saint_marys, texas_southern, -1, points_dict, [2,0])
    east_firstfour_11 = sim_game(ucla, michigan_state, -1, points_dict, [1,0])

    #####  West Region  #####
    # Round of 64
    r64_w_game1 = sim_game(gonzaga, west_firstfour_16, 64, points_dict, [1,3])
    r64_w_game2 = sim_game(oklahoma, missouri, 64, points_dict, [1,0])
    r64_w_game3 = sim_game(creighton, ucsb, 64, points_dict, [1,0])
    r64_w_game4 = sim_game(virginia, ohio, 64, points_dict, [2,0])
    r64_w_game5 = sim_game(usc, west_firstfour_11, 64, points_dict, [1,1])
    r64_w_game6 = sim_game(kansas, eastern_washington, 64, points_dict, [1,0])
    r64_w_game7 = sim_game(oregon, vcu, 64, points_dict, [1,0])
    r64_w_game8 = sim_game(iowa, grand_canyon, 64, points_dict, [1,1])

    # Round of 32
    r32_w_game1 = sim_game(r64_w_game1, r64_w_game2, 32, points_dict, [1,1])
    r32_w_game2 = sim_game(r64_w_game3, r64_w_game4, 32, points_dict, [1,1])
    r32_w_game3 = sim_game(r64_w_game5, r64_w_game6, 32, points_dict, [1,3])
    r32_w_game4 = sim_game(r64_w_game7, r64_w_game8, 32, points_dict, [1,1])

    # Sweet 16
    r16_w_game1 = sim_game(r32_w_game1, r32_w_game2, 16, points_dict, [1,1])
    r16_w_game2 = sim_game(r32_w_game3, r32_w_game4, 16, points_dict, [1,1])

    # Elite 8
    west_winner = sim_game(r16_w_game1, r16_w_game2, 8, points_dict, [1,1])

    ##### Midwest Region #####
    # Round of 64
    r64_mw_game1 = sim_game(illinois, drexel, 64, points_dict, [1,2])
    r64_mw_game2 = sim_game(loyola_chicago, georgia_tech, 64, points_dict, [1,1])
    r64_mw_game3 = sim_game(tennessee, oregon_state, 64, points_dict, [2,1])
    r64_mw_game4 = sim_game(oklahoma_state, liberty, 64, points_dict, [1,0])
    r64_mw_game5 = sim_game(san_diego_state, syracuse, 64, points_dict, [2,1])
    r64_mw_game6 = sim_game(west_virginia, morehead_state, 64, points_dict, [1,1])
    r64_mw_game7 = sim_game(clemson, rutgers, 64, points_dict, [2,0])
    r64_mw_game8 = sim_game(houston, cleveland_state, 64, points_dict, [1,3])

    # Round of 32
    r32_mw_game1 = sim_game(r64_mw_game1, r64_mw_game2, 32, points_dict, [2,1])
    r32_mw_game2 = sim_game(r64_mw_game3, r64_mw_game4, 32, points_dict, [1,1])
    r32_mw_game3 = sim_game(r64_mw_game5, r64_mw_game6, 32, points_dict, [1,0])
    r32_mw_game4 = sim_game(r64_mw_game7, r64_mw_game8, 32, points_dict, [2,0])

    # Sweet 16
    r16_mw_game1 = sim_game(r32_mw_game1, r32_mw_game2, 16, points_dict, [2,0])
    r16_mw_game2 = sim_game(r32_mw_game3, r32_mw_game4, 16, points_dict, [2,1])

    # Elite 8
    midwest_winner = sim_game(r16_mw_game1, r16_mw_game2, 8, points_dict, [2,0])


    ##### East Region    #####
    # Round of 64
    r64_e_game1 = sim_game(michigan, east_firstfour_16, 64, points_dict, [1,1])
    r64_e_game2 = sim_game(lsu, saint_bonaventure, 64, points_dict, [1,1])
    r64_e_game3 = sim_game(colorado, georgetown, 64, points_dict, [1,2])
    r64_e_game4 = sim_game(florida_state, unc_greensboro, 64, points_dict, [1,1])
    r64_e_game5 = sim_game(byu, east_firstfour_11, 64, points_dict, [2,1])
    r64_e_game6 = sim_game(texas, abilene_christian, 64, points_dict, [2,0])
    r64_e_game7 = sim_game(connecticut, maryland, 64, points_dict, [2,0])
    r64_e_game8 = sim_game(alabama, iona, 64, points_dict, [1,1])

    # Round of 32
    r32_e_game1 = sim_game(r64_e_game1, r64_e_game2, 32, points_dict, [1,0])
    r32_e_game2 = sim_game(r64_e_game3, r64_e_game4, 32, points_dict, [2,1])
    r32_e_game3 = sim_game(r64_e_game5, r64_e_game6, 32, points_dict, [1,2])
    r32_e_game4 = sim_game(r64_e_game7, r64_e_game8, 32, points_dict, [2,1])

    # Sweet 16
    r16_e_game1 = sim_game(r32_e_game1, r32_e_game2, 16, points_dict, [1,1])
    r16_e_game2 = sim_game(r32_e_game3, r32_e_game4, 16, points_dict, [1,1])

    # Elite 8
    east_winner = sim_game(r16_e_game1, r16_e_game2, 8, points_dict, [2,0])

    ##### South Region   #####
    # Round of 64
    r64_s_game1 = sim_game(baylor, hartford, 64, points_dict, [1,2])
    r64_s_game2 = sim_game(north_carolina, wisconsin, 64, points_dict, [2,2])
    r64_s_game3 = sim_game(villanova, winthrop, 64, points_dict, [1,1])
    r64_s_game4 = sim_game(purdue, north_texas, 64, points_dict, [2,0])
    r64_s_game5 = sim_game(texas_tech, utah_state, 64, points_dict, [1,1])
    r64_s_game6 = sim_game(arkansas, colgate, 64, points_dict, [1,1])
    r64_s_game7 = sim_game(florida, virginia_tech, 64, points_dict, [1,0])
    r64_s_game8 = sim_game(ohio_state, oral_roberts, 64, points_dict, [2,0])

    # Round of 32
    r32_s_game1 = sim_game(r64_s_game1, r64_s_game2, 32, points_dict, [1,1])
    r32_s_game2 = sim_game(r64_s_game3, r64_s_game4, 32, points_dict, [1,2])
    r32_s_game3 = sim_game(r64_s_game5, r64_s_game6, 32, points_dict, [2,0])
    r32_s_game4 = sim_game(r64_s_game7, r64_s_game8, 32, points_dict, [2,0])

    # Sweet 16
    r16_s_game1 = sim_game(r32_s_game1, r32_s_game2, 16, points_dict, [1,1])
    r16_s_game2 = sim_game(r32_s_game3, r32_s_game4, 16, points_dict, [1,0])

    # Elite 8
    south_winner = sim_game(r16_s_game1, r16_s_game2, 8, points_dict, [1,1])

    # Final Four
    east_west_winner = sim_game(east_winner, west_winner, 4, points_dict, [2,0])
    south_midwest_winner = sim_game(south_winner, midwest_winner, 4, points_dict, [1,1])

    # Championship
    champion = sim_game(east_west_winner, south_midwest_winner, 2, points_dict, [2,1])
